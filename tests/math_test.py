...
class MathTest(TestCase):
    ...
    def test_sum_last(self):
        x = jax.random.normal(jax.random.key(42), (2, 3, 4))
    ...
    def test_log_expbig_minus_expsmall(self):
        small = jax.random.normal(jax.random.key(42), (2, 3, 4))
        big = small + jax.random.uniform(jax.random.key(43), (2, 3, 4))
    ...
    def test_log_beta(self):
        a = jnp.abs(jax.random.normal(jax.random.key(42), (2, 3, 4)))
        b = jnp.abs(jax.random.normal(jax.random.key(43), (3, 4)))
    ...
    def test_log_beta_bivariate(self):
        a = jnp.abs(jax.random.normal(jax.random.key(42), (4, 3, 2)))
